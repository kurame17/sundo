...
class AuctionPostsControllerTest < ActionController::TestCase
  ...
  test "should create auction_post" do
    assert_difference('AuctionPost.count') do
      post :create, auction_post: { content: @auction_post.content, string: @auction_post.string, string: @auction_post.string, text: @auction_post.text, title: @auction_post.title, username: @auction_post.username }
    end
  ...
  test "should update auction_post" do
    patch :update, id: @auction_post, auction_post: { content: @auction_post.content, string: @auction_post.string, string: @auction_post.string, text: @auction_post.text, title: @auction_post.title, username: @auction_post.username }
    assert_redirected_to auction_post_path(assigns(:auction_post))
  end
